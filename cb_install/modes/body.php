...
<body>
	<div id="head">
    	<span id="logo"><span style="color:#09c">ClipBucket</span> Installer v<?php echo VERSION?>  <?php echo STATE?></span>
    </div>
    ...
    <div align="center" style="padding-top:10px; color:#999">
    	ClipBucket <?php echo VERSION?> is an effort of Arslan Hassan, Fawaz Tahir and some great supporters.<br />
&copy; ClipBucket 2007 - <?php echo date("Y",time())?> | Code written by Arslan &amp; his team
    </div>
