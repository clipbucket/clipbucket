...
?>
<p>You are now going to upgrade from <?php echo $old_version?> to <?php echo VERSION?>, please read <strong><a href="http://docs.clip-bucket.com/clipbucket-docs/clipbucket-installation">this documentation</a></strong> for further info and help, please click continue upgrade </p>
